...
{
    /// <inheritdoc />
    public partial class AddNewEmailConfirmedColumn : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailDomain = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_Items_TargetItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Universities_EmailDomain",
                table: "Universities",
                column: "EmailDomain",
                unique: true);
